...
function Login() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-auth-cinema bg-cover bg-center px-4">
      <div className="w-full max-w-[400px] p-8 md:p-10 rounded-2xl bg-black/70 backdrop-blur-xl border border-white/10 shadow-card animate-fade-up">
        ...
        {/* Heading */}
        <h1 className="text-center text-2xl font-semibold text-white">Masuk</h1>
        ...
        <div className="flex justify-between items-center mt-4 text-xs">
          <Link to="/register" className="text-chill-muted hover:text-white">
            Belum punya akun?{' '}
            <span className="text-white font-semibold">Daftar</span>
          </Link>
          <a href="#" className="text-chill-muted hover:text-white">
            Lupa kata sandi?
          </a>
        </div>
